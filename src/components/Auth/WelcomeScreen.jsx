...
import { INITIAL_FRIENDS } from '../../data/mockSocialData';
...
export const WelcomeScreen = () => {
  ...
  return (
    <div className="min-h-[85vh] flex flex-col justify-between items-center px-6 py-6 text-center select-none relative overflow-hidden bg-[#090C15] text-slate-100 animate-in fade-in duration-300">
      ...
      <div className="relative w-64 h-64 sm:w-72 sm:h-72 my-6 flex items-center justify-center z-10">
        ...
        <div
          ...
          title="Create Account on LinkUp"
        >
          <LogoSymbol size={64} />
        ...
        {/* Satellite Friend Avatar 1 (Top Left) */}
        ...
        {/* Satellite Friend Avatar 2 (Top Right) */}
        ...
        {/* Satellite Friend Avatar 3 (Middle Right) */}
        ...
        {/* Satellite Friend Avatar 4 (Bottom Left) */}
        ...
        {/* Satellite Friend Avatar 5 (Middle Left) */}
